...
MEDIUM_B9: list[dict] = [
    ...
    _c("Our healthcare FHIR API returns 500 on certain patient queries. How do I trace it?", "MEDIUM", "debugging", "en"),
    _c("The autonomous vehicle perception stack drops frames under load. How do I profile it?", "MEDIUM", "debugging", "en"),
    _c("VR headset tracking jitters in one corner of the play space. What could cause it?", "MEDIUM", "debugging", "en"),
    ...
    _c("Brainstorm 5 ways to reduce false positives in our intrusion detection system", "MEDIUM", "brainstorming", "en"),
    ...
    _c("Brainstorm features for an adaptive learning platform that personalizes content", "MEDIUM", "brainstorming", "en"),
...
COMPLEX_B9: list[dict] = [
    ...
    _c("Design a security operations center platform with SIEM integration, threat hunting workflows, incident response playbooks, and compliance reporting.", "COMPLEX", "system-design", "en"),
    _c("Build a zero-trust network access system with device posture checks, continuous authentication, micro-segmentation, and audit logging.", "COMPLEX", "system-design", "en"),
    _c("Design a vulnerability management pipeline with asset discovery, scanning, prioritization by risk, patch orchestration, and executive dashboards.", "COMPLEX", "system-design", "en"),

    # ── DevOps automation multi-requirement ──
    _c("Design a GitOps platform with multi-cluster sync, drift detection, rollback automation, secret management, and approval workflows.", "COMPLEX", "system-design", "en"),
    _c("Build an infrastructure provisioning system with Terraform state locking, cost estimation, policy-as-code validation, and change approval gates.", "COMPLEX", "system-design", "en"),
    _c("Design a CI/CD pipeline for microservices with parallel builds, artifact signing, environment promotion, canary deployment, and rollback.", "COMPLEX", "system-design", "en"),

    # ── Embedded systems multi-requirement ──
    _c("Design an automotive ECU software architecture with AUTOSAR stack, OTA updates, diagnostic services, and safety monitoring.", "COMPLEX", "system-design", "en"),
    _c("Build a fleet management system for industrial IoT with device provisioning, remote diagnostics, firmware OTA, and predictive maintenance.", "COMPLEX", "system-design", "en"),
    _c("Design a real-time control system for a drone with sensor fusion, path planning, fail-safe modes, and telemetry streaming.", "COMPLEX", "system-design", "en"),

    # ── Fintech multi-requirement ──
    _c("Design a payment orchestration platform with multi-gateway routing, 3DS handling, reconciliation, dispute management, and PCI compliance.", "COMPLEX", "system-design", "en"),
    _c("Build an AML transaction monitoring system with rule engine, ML anomaly detection, case management, and regulatory reporting.", "COMPLEX", "system-design", "en"),
    _c("Design a core banking API with account management, transaction processing, audit trails, and regulatory compliance.", "COMPLEX", "system-design", "en"),

    # ── EdTech multi-requirement ──
    _c("Design an adaptive learning platform with content recommendation, progress tracking, assessment engine, and instructor dashboards.", "COMPLEX", "system-design", "en"),
    _c("Build a proctoring system with face detection, screen monitoring, behavior analysis, and integrity reporting.", "COMPLEX", "system-design", "en"),
    _c("Design an LMS with SCORM support, video streaming, discussion forums, gradebook, and mobile app sync.", "COMPLEX", "system-design", "en"),

    # ── Healthcare AI multi-requirement ──
    _c("Design a clinical decision support system with FHIR integration, evidence-based rules, explainability, and audit trails for FDA compliance.", "COMPLEX", "system-design", "en"),
    _c("Build a medical imaging pipeline with DICOM ingestion, AI inference, radiologist workflow, and HIPAA-compliant storage.", "COMPLEX", "system-design", "en"),
    _c("Design a patient engagement platform with appointment scheduling, telehealth, medication reminders, and interoperability.", "COMPLEX", "system-design", "en"),

    # ── Autonomous vehicles multi-requirement ──
    _c("Design a perception stack with lidar, camera, radar fusion, object tracking, and redundancy for L4 autonomy.", "COMPLEX", "system-design", "en"),
    _c("Build a simulation platform for AV testing with scenario generation, physics engine, sensor simulation, and regression testing.", "COMPLEX", "system-design", "en"),
    _c("Design a V2X communication system with DSRC, message prioritization, security, and integration with the driving stack.", "COMPLEX", "system-design", "en"),

    # ── AR/VR multi-requirement ──
    _c("Design a multiplayer VR platform with spatial audio, avatar sync, physics, and low-latency networking.", "COMPLEX", "system-design", "en"),
    _c("Build an AR content management system with 3D asset streaming, occlusion handling, and analytics.", "COMPLEX", "system-design", "en"),
    _c("Design a mixed reality training simulator with hand tracking, object interaction, and performance assessment.", "COMPLEX", "system-design", "en"),

    # ── NLP multi-requirement ──
    _c("Design an enterprise search system with document ingestion, embedding, retrieval, reranking, and answer extraction.", "COMPLEX", "system-design", "en"),
    _c("Build a multilingual NER pipeline with model serving, entity linking, and confidence calibration.", "COMPLEX", "system-design", "en"),
    _c("Design a conversational AI platform with intent detection, slot filling, backend integration, and fallback handling.", "COMPLEX", "system-design", "en"),

    # ── Computer vision multi-requirement ──
    _c("Design a video analytics pipeline with object detection, tracking, re-identification, and alert generation.", "COMPLEX", "system-design", "en"),
    _c("Build a defect inspection system with image capture, model inference, classification, and reporting.", "COMPLEX", "system-design", "en"),
    _c("Design a facial recognition system with liveness detection, enrollment, matching, and privacy controls.", "COMPLEX", "system-design", "en"),

    # ── Quantum / sustainability multi-requirement ──
    _c("Design a quantum algorithm development platform with circuit design, simulation, backend submission, and result analysis.", "COMPLEX", "system-design", "en"),
    _c("Build a carbon accounting system for cloud workloads with usage tracking, emission factors, and reporting.", "COMPLEX", "system-design", "en"),
    _c("Design a green data center management system with workload scheduling, renewable forecasting, and PUE optimization.", "COMPLEX", "system-design", "en"),

    # ── Security / architecture ──
    _c("Design a secure software supply chain with SBOM generation, vulnerability scanning, signing, and policy enforcement.", "COMPLEX", "security-analysis", "en"),
    _c("Plan a migration from monolithic to microservices with API versioning, feature flags, and gradual traffic shift.", "COMPLEX", "migration", "en"),
    _c("Design a multi-tenant SaaS platform with isolation, billing, and compliance per tenant.", "COMPLEX", "architecture", "en"),

    # ── Non-English COMPLEX ──
    _c("设计一个安全运营中心平台，包括 SIEM 集成、威胁狩猎工作流、事件响应手册和合规报告", "COMPLEX", "system-design", "zh"),
    ...
    _c("设计一个医疗影像流水线，包括 DICOM 摄取、AI 推理、放射科工作流和 HIPAA 合规存储", "COMPLEX", "system-design", "zh"),
    _c("设计一个量子算法开发平台，包括电路设计、仿真、后端提交和结果分析", "COMPLEX", "system-design", "zh"),

    _c("セキュリティオペレーションセンターを設計してください。SIEM連携、脅威ハンティング、インシデント対応、コンプライアンスレポートを含めてください。", "COMPLEX", "system-design", "ja"),
    _c("ゼロトラストネットワークアクセスシステムを設計してください。デバイスポスチャーチェック、継続認証、マイクロセグメンテーションを含めてください。", "COMPLEX", "system-design", "ja"),
    _c("自律走行の知覚スタックを設計してください。LiDAR、カメラ、レーダー融合、オブジェクト追跡、L4冗長性を含めてください。", "COMPLEX", "system-design", "ja"),

    _c("보안 운영 센터 플랫폼을 설계하세요. SIEM 연동, 위협 헌팅, 사고 대응 플레이북, 규정 준수 보고를 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
    _c("자율주행 인지 스택을 설계하세요. LiDAR, 카메라, 레이더 융합, 객체 추적, L4 중복을 포함해야 합니다.", "COMPLEX", "system-design", "ko"),

    _c("صمم منصة مركز عمليات أمنية تشمل تكامل SIEM وصيد التهديدات ودفاتر استجابة الحوادث والتقارير الامتثال.", "COMPLEX", "system-design", "ar"),
    _c("صمم نظام وصول شبكة صفر ثقة مع فحص حالة الجهاز والتحقق المستمر والجزء الدقيق وتسجيل التدقيق.", "COMPLEX", "system-design", "ar"),

    _c("Спроектируй платформу SOC с интеграцией SIEM, охотой за угрозами, плейбуками реагирования и отчётами по соответствию.", "COMPLEX", "system-design", "ru"),
    _c("Спроектируй стек восприятия для автономного вождения с лидаром, камерами, радаром, трекингом и резервированием.", "COMPLEX", "system-design", "ru"),

    _c("Diseña una plataforma SOC con integración SIEM, caza de amenazas, playbooks de respuesta e informes de cumplimiento.", "COMPLEX", "system-design", "es"),
    _c("Diseña un stack de percepción para conducción autónoma con fusión lidar-cámara-radar, seguimiento y redundancia.", "COMPLEX", "system-design", "es"),

    _c("Entwerfe eine SOC-Plattform mit SIEM-Integration, Threat Hunting, Incident Response Playbooks und Compliance-Berichten.", "COMPLEX", "system-design", "de"),
    _c("Entwerfe einen Wahrnehmungsstack für autonomes Fahren mit Lidar-Kamera-Radar-Fusion, Tracking und Redundanz.", "COMPLEX", "system-design", "de"),

    _c("Conçois une plateforme SOC avec intégration SIEM, chasse aux menaces, playbooks de réponse et rapports de conformité.", "COMPLEX", "system-design", "fr"),
    _c("Conçois un stack de perception pour véhicule autonome avec fusion lidar-caméra-radar, suivi et redondance.", "COMPLEX", "system-design", "fr"),

    _c("Projete uma plataforma SOC com integração SIEM, caça a ameaças, playbooks de resposta e relatórios de conformidade.", "COMPLEX", "system-design", "pt"),
    _c("Projete um stack de percepção para veículo autônomo com fusão lidar-câmera-radar, rastreamento e redundância.", "COMPLEX", "system-design", "pt"),

    _c("एक SOC प्लेटफॉर्म डिज़ाइन करें जिसमें SIEM इंटीग्रेशन, थ्रेट हंटिंग, इंसिडेंट रिस्पॉन्स प्लेबुक और कंप्लायंस रिपोर्टिंग शामिल हो।", "COMPLEX", "system-design", "hi"),

    _c("SIEM entegrasyonu, tehdit avı, olay müdahale playbook'ları ve uyumluluk raporlaması içeren bir SOC platformu tasarlayın.", "COMPLEX", "system-design", "tr"),

    _c("Thiết kế nền tảng SOC với tích hợp SIEM, săn mối đe dọa, playbook phản hồi sự cố và báo cáo tuân thủ.", "COMPLEX", "system-design", "vi"),

    _c("Zaprojektuj platformę SOC z integracją SIEM, polowaniem na zagrożenia, playbookami reagowania i raportami zgodności.", "COMPLEX", "system-design", "pl"),

    # ── More COMPLEX to reach ~100 ──
    _c("Design a DevSecOps pipeline with SAST, DAST, dependency scanning, container signing, and deployment gates.", "COMPLEX", "system-design", "en"),
    _c("Build a real-time fraud detection system with rule engine, ML scoring, case management, and regulatory reporting.", "COMPLEX", "system-design", "en"),
    _c("Design a telemedicine platform with video calls, EHR integration, prescription workflow, and HIPAA compliance.", "COMPLEX", "system-design", "en"),
    _c("Build a simulation environment for AV validation with scenario injection, sensor noise, and metrics collection.", "COMPLEX", "system-design", "en"),
    _c("Design a spatial computing platform with 6DoF tracking, hand gestures, shared anchors, and persistence.", "COMPLEX", "system-design", "en"),
    _c("Build a document intelligence pipeline with OCR, entity extraction, classification, and workflow routing.", "COMPLEX", "system-design", "en"),
    _c("Design a video surveillance system with edge inference, cloud aggregation, search, and retention policies.", "COMPLEX", "system-design", "en"),
    _c("Build a quantum chemistry simulation platform with circuit compilation, backend selection, and result visualization.", "COMPLEX", "system-design", "en"),
    _c("Design a sustainable cloud platform with carbon-aware scheduling, renewable matching, and reporting.", "COMPLEX", "system-design", "en"),
    _c("Design a multi-region active-active system with conflict resolution, eventual consistency, and failover.", "COMPLEX", "architecture", "en"),
    _c("Plan a migration from VMs to Kubernetes with zero downtime and rollback capability.", "COMPLEX", "migration", "en"),
    _c("Design a secrets management system with rotation, audit, and least-privilege access.", "COMPLEX", "security-analysis", "en"),
    _c("Build an industrial control system with PLC integration, SCADA, historian, and security monitoring.", "COMPLEX", "system-design", "en"),
    _c("Design a regulatory reporting platform for fintech with data lineage, validation, and audit.", "COMPLEX", "system-design", "en"),
    _c("Build a competency-based learning platform with skill graphs, assessments, and credentialing.", "COMPLEX", "system-design", "en"),
    _c("Design a clinical trial management system with patient recruitment, consent, and data collection.", "COMPLEX", "system-design", "en"),
    _c("Build a V2V communication system with message signing, prioritization, and geofencing.", "COMPLEX", "system-design", "en"),
    _c("Design a holographic display pipeline with light field rendering and eye tracking.", "COMPLEX", "system-design", "en"),
    _c("Build a multilingual customer support system with translation, sentiment, and escalation.", "COMPLEX", "system-design", "en"),
    _c("Design a defect detection system with multi-camera sync, 3D reconstruction, and classification.", "COMPLEX", "system-design", "en"),
]
...
REASONING_B9: list[dict] = [
    # ── Formal proofs ──
    _c("Prove that the halting problem is undecidable using a diagonalization argument.", "REASONING", "formal-proof", "en"),
    _c("Prove that the set of recursively enumerable languages is closed under union but not under complement.", "REASONING", "formal-proof", "en"),
    _c("Prove that every context-free language has a pumping lemma. State and prove the lemma.", "REASONING", "formal-proof", "en"),
    ...
    _c("Prove that the rationals are countable by constructing an explicit bijection with the naturals.", "REASONING", "formal-proof", "en"),
    ...
    _c("Prove that Dijkstra's algorithm correctly finds shortest paths when all edge weights are non-negative.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that binary search runs in O(log n) time and always finds the target if present.", "REASONING", "algorithm-proof", "en"),
    ...
    _c("Prove that the Ford-Fulkerson method terminates and finds a maximum flow when capacities are integers.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that quicksort's expected comparison count is O(n log n).", "REASONING", "algorithm-proof", "en"),
    _c("Prove that the two-pointer technique correctly finds a pair with a given sum in a sorted array.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that the greedy coin change algorithm is optimal for certain coin systems.", "REASONING", "algorithm-proof", "en"),

    # ── Math derivations ──
    _c("Derive the closed-form solution for the recurrence T(n) = 2T(n/2) + n using the master theorem.", "REASONING", "math-derivation", "en"),
    ...
    _c("Derive the Bayes optimal classifier for binary classification with 0-1 loss.", "REASONING", "math-derivation", "en"),
    ...
    _c("Prove that every finite game has at least one mixed-strategy Nash equilibrium.", "REASONING", "game-theory", "en"),
    _c("Analyze the iterated prisoner's dilemma: under what conditions does cooperation emerge?", "REASONING", "game-theory", "en"),
    _c("Prove that in a symmetric game, a symmetric Nash equilibrium exists.", "REASONING", "game-theory", "en"),
    _c("Derive the optimal bidding strategy in a first-price sealed-bid auction with independent private values.", "REASONING", "game-theory", "en"),
    _c("Prove that the minimax theorem holds for two-player zero-sum games.", "REASONING", "game-theory", "en"),
    _c("Analyze the subgame-perfect equilibrium in a multi-stage game with perfect information.", "REASONING", "game-theory", "en"),
    ...
    _c("Dijkstraのアルゴリズムが非負の重みで最短経路を正しく見つけることを証明してください", "REASONING", "algorithm-proof", "ja"),
    ...
    _c("Dijkstra 알고리즘이 음이 아닌 가중치에서 최단 경로를 올바르게 찾음을 증명하세요", "REASONING", "algorithm-proof", "ko"),
    ...
    _c("أثبت أن خوارزمية Dijkstra تجد المسارات الأقصر بشكل صحيح عندما تكون الأوزان غير سالبة.", "REASONING", "algorithm-proof", "ar"),

    _c("Докажи, что проблема остановки неразрешима, используя диагональный аргумент.", "REASONING", "formal-proof", "ru"),
    _c("Докажи, что алгоритм Дейкстры правильно находит кратчайшие пути при неотрицательных весах.", "REASONING", "algorithm-proof", "ru"),

    _c("Demuestra que el problema de la parada es indecidible usando el argumento diagonal.", "REASONING", "formal-proof", "es"),
    _c("Demuestra que el algoritmo de Dijkstra encuentra correctamente los caminos más cortos con pesos no negativos.", "REASONING", "algorithm-proof", "es"),

    _c("Beweise, dass das Halteproblem unentscheidbar ist, mit dem Diagonalargument.", "REASONING", "formal-proof", "de"),
    _c("Beweise, dass Dijkstras Algorithmus bei nichtnegativen Gewichten korrekt kürzeste Wege findet.", "REASONING", "algorithm-proof", "de"),

    _c("Démontre que le problème de l'arrêt est indécidable en utilisant l'argument diagonal.", "REASONING", "formal-proof", "fr"),
    _c("Démontre que l'algorithme de Dijkstra trouve correctement les plus courts chemins avec des poids non négatifs.", "REASONING", "algorithm-proof", "fr"),

    _c("Prove que o problema da parada é indecidível usando o argumento diagonal.", "REASONING", "formal-proof", "pt"),
    _c("Prove que o algoritmo de Dijkstra encontra corretamente os caminhos mais curtos com pesos não negativos.", "REASONING", "algorithm-proof", "pt"),

    _c("सिद्ध करें कि हॉल्टिंग समस्या अनिर्णायक है (विकर्ण तर्क का उपयोग करके)।", "REASONING", "formal-proof", "hi"),

    _c("Durdurma probleminin karar verilemez olduğunu köşegen argümanıyla kanıtlayın.", "REASONING", "formal-proof", "tr"),

    _c("Chứng minh bài toán dừng là không quyết định được bằng lập luận chéo.", "REASONING", "formal-proof", "vi"),

    _c("Udowodnij, że problem stopu jest nierozstrzygalny, używając argumentu diagonalnego.", "REASONING", "formal-proof", "pl"),
    ...
    _c("Derive the optimal k for k-means clustering when the true number of clusters is known.", "REASONING", "math-derivation", "en"),
    _c("Prove that the perceptron algorithm converges when the data is linearly separable.", "REASONING", "algorithm-proof", "en"),
    ...
    _c("Prove that in a repeated game, the grim trigger strategy is a Nash equilibrium.", "REASONING", "game-theory", "en"),
