...
SIMPLE_B8: list[dict] = [
    ...
    _c("I'm writing a paper on supply chain management and I need to know the basic definition. Could you tell me what a supply chain is in one or two sentences?", "SIMPLE", "factual-qa", "en"),
    _c("My doctor mentioned something called hypertension during my checkup. I forgot to ask what it means. Can you give me a brief definition?", "SIMPLE", "factual-qa", "en"),
    _c("I've been playing video games for years but I still don't know what people mean when they say RNG. What does RNG stand for?", "SIMPLE", "factual-qa", "en"),
    _c("I'm learning to cook and the recipe says 'al dente'. I have no idea what that means. Can you explain in one sentence?", "SIMPLE", "factual-qa", "en"),
    _c("Someone at work mentioned EOQ in a meeting about inventory. I nodded along but have no clue. What is EOQ?", "SIMPLE", "factual-qa", "en"),
...
MEDIUM_B8: list[dict] = [
    ...
    _c("Write a Python script to parse a game save file in JSON format and extract player stats", "MEDIUM", "simple-code", "en"),
    _c("Implement a simple matchmaking algorithm that pairs players by ELO rating within a tolerance", "MEDIUM", "simple-code", "en"),
    _c("Explain how hitbox detection works in 2D platformer games", "MEDIUM", "explanation", "en"),
    _c("My game's physics feels floaty. How do I tune gravity and jump velocity for better feel?", "MEDIUM", "debugging", "en"),
    ...
    _c("Write a Python script to scale a recipe from 4 servings to 12, handling fractional measurements", "MEDIUM", "simple-code", "en"),
    ...
    _c("Write a Python script to calculate the distance to a star given its parallax angle", "MEDIUM", "simple-code", "en"),
    ...
    _c("Classify these words by their morphological structure (root, prefix, suffix)", "MEDIUM", "classification", "en"),
    ...
    _c("Classify these symptoms into likely organ systems (cardiovascular, respiratory, etc.)", "MEDIUM", "classification", "en"),
    ...
    _c("Write a Python script to calculate optimal planting density from field area and crop spacing", "MEDIUM", "simple-code", "en"),
    ...
    _c("Write a Python script to calculate a player's true shooting percentage from box score data", "MEDIUM", "simple-code", "en"),
    ...
    _c("Write a Python script to calculate reorder point given demand rate and lead time", "MEDIUM", "simple-code", "en"),
    ...
    # ── Japanese MEDIUM ──
    _c("ゲームセーブファイルを解析してプレイヤーステータスを抽出するPythonスクリプトを書いてください", "MEDIUM", "simple-code", "ja"),
    ...
    # ── Korean MEDIUM ──
    _c("게임 세이브 파일을 파싱하여 플레이어 스탯을 추출하는 Python 스크립트를 작성하세요", "MEDIUM", "simple-code", "ko"),
    ...
    _c("Implement a function to convert between Celsius and Fahrenheit for recipe scaling", "MEDIUM", "simple-code", "en"),
...
COMPLEX_B8: list[dict] = [
    ...
    _c("Design a multiplayer game backend with matchmaking, authoritative server, anti-cheat, replay system, and cross-region latency compensation.", "COMPLEX", "system-design", "en"),
    _c("Build a game engine physics subsystem with rigid body dynamics, collision detection, constraint solving, and spatial partitioning.", "COMPLEX", "complex-code", "en"),
    _c("Design a live-service game economy with virtual currency, marketplace, anti-fraud, and balance tuning pipeline.", "COMPLEX", "system-design", "en"),
    _c("Implement a networked game sync protocol with delta compression, interest management, and rollback netcode.", "COMPLEX", "complex-code", "en"),

    # ── Cooking / food: system design ──
    _c("Design a recipe recommendation platform with dietary constraints, ingredient substitution, scaling, nutrition analysis, and meal planning.", "COMPLEX", "system-design", "en"),
    _c("Build a food safety compliance system with HACCP tracking, supplier audits, recall management, and regulatory reporting.", "COMPLEX", "system-design", "en"),

    # ── Music: complex system ──
    _c("Design a music production platform with DAW integration, plugin hosting, collaboration, version control, and export pipelines.", "COMPLEX", "system-design", "en"),
    _c("Build an automated music transcription pipeline with source separation, pitch detection, rhythm analysis, and notation generation.", "COMPLEX", "ml-pipeline", "en"),

    # ── Astronomy: infrastructure, ML ──
    _c("Design an astronomy data pipeline for telescope observations: ingestion, calibration, reduction, catalog generation, and archive.", "COMPLEX", "infrastructure", "en"),
    _c("Build an exoplanet detection pipeline with light curve analysis, transit fitting, false positive filtering, and classification.", "COMPLEX", "ml-pipeline", "en"),

    # ── Linguistics: ML pipeline, migration ──
    _c("Design an NLP pipeline for low-resource languages: data collection, annotation, model training, evaluation, and deployment.", "COMPLEX", "ml-pipeline", "en"),
    _c("Plan a migration from rule-based to neural machine translation with A/B testing and quality monitoring.", "COMPLEX", "migration", "en"),

    # ── Law: system design, security ──
    _c("Design a legal document management system with version control, redaction, access control, audit trails, and e-discovery support.", "COMPLEX", "system-design", "en"),
    _c("Perform a security audit of a contract management platform. Identify attack vectors, compliance gaps, and propose mitigations.", "COMPLEX", "security-analysis", "en"),

    # ── Medicine: system design, compliance ──
    _c("Design a clinical trial management system with patient enrollment, consent tracking, adverse event reporting, and regulatory submission.", "COMPLEX", "system-design", "en"),
    _c("Build a medical imaging pipeline with DICOM ingestion, anonymization, AI inference, and radiologist workflow integration.", "COMPLEX", "ml-pipeline", "en"),

    # ── Agriculture: system design, infrastructure ──
    _c("Design a precision agriculture platform with sensor networks, satellite imagery, yield prediction, irrigation control, and supply chain integration.", "COMPLEX", "system-design", "en"),
    _c("Build a farm management system with crop planning, inventory, equipment tracking, labor scheduling, and compliance reporting.", "COMPLEX", "infrastructure", "en"),

    # ── Fashion: system design ──
    _c("Design an apparel supply chain platform with design-to-manufacturing workflow, size grading, material sourcing, and sustainability tracking.", "COMPLEX", "system-design", "en"),
    _c("Build a fashion recommendation engine with style analysis, fit prediction, inventory optimization, and personalization.", "COMPLEX", "ml-pipeline", "en"),

    # ── Architecture (buildings): system design ──
    _c("Design a building information modeling (BIM) platform with 3D modeling, clash detection, quantity takeoff, and contractor coordination.", "COMPLEX", "system-design", "en"),
    _c("Design a smart building management system with HVAC optimization, occupancy sensing, energy analytics, and maintenance prediction.", "COMPLEX", "architecture", "en"),

    # ── Sports analytics: complex system ──
    _c("Design a sports analytics platform with real-time data ingestion, play-by-play analysis, player tracking, and coaching dashboard.", "COMPLEX", "system-design", "en"),
    _c("Build a player valuation model with performance metrics, contract data, injury history, and market comparables.", "COMPLEX", "data-analysis", "en"),

    # ── Supply chain: complex systems ──
    _c("Design a global supply chain visibility platform with real-time tracking, demand forecasting, risk scoring, and supplier collaboration.", "COMPLEX", "system-design", "en"),
    _c("Plan a migration from legacy ERP to modern SCM with data migration, integration, and phased rollout.", "COMPLEX", "migration", "en"),
    _c("Design a supply chain security framework with supplier vetting, shipment verification, and tamper detection.", "COMPLEX", "security-analysis", "en"),
    _c("Optimize a multi-echelon inventory network: safety stock, reorder points, and transportation cost trade-offs.", "COMPLEX", "performance", "en"),

    # ── Adversarial: short-but-COMPLEX ──
    _c("Implement a Raft consensus module with leader election, log replication, membership changes, and snapshotting.", "COMPLEX", "complex-code", "en"),
    _c("Design a zero-trust API gateway with mTLS, OPA policies, rate limiting, and audit logging.", "COMPLEX", "architecture", "en"),
    _c("Build a CRDT-based collaborative editor with operational transforms and conflict resolution.", "COMPLEX", "complex-code", "en"),
    ...
    _c("设计一个精准农业平台，包括传感器网络、卫星影像、产量预测、灌溉控制和供应链集成", "COMPLEX", "system-design", "zh"),
    _c("设计一个全球供应链可视化平台，包括实时追踪、需求预测、风险评分和供应商协作", "COMPLEX", "system-design", "zh"),

    # ── Japanese COMPLEX ──
    _c("マルチプレイヤーゲームバックエンドを設計してください。マッチング、オーソリティティブサーバー、アンチチート、リプレイシステムを含めてください。", "COMPLEX", "system-design", "ja"),
    _c("レシピ推薦プラットフォームを設計してください。食事制限、食材代替、スケーリング、栄養分析を含めてください。", "COMPLEX", "system-design", "ja"),
    _c("臨床試験管理システムを設計してください。患者登録、同意追跡、有害事象報告を含めてください。", "COMPLEX", "system-design", "ja"),
    _c("精密農業プラットフォームを設計してください。センサーネットワーク、衛星画像、収量予測、灌漑制御を含めてください。", "COMPLEX", "system-design", "ja"),
    _c("グローバルサプライチェーン可視化プラットフォームを設計してください。リアルタイム追跡、需要予測、リスクスコアリングを含めてください。", "COMPLEX", "system-design", "ja"),

    # ── Korean COMPLEX ──
    _c("멀티플레이어 게임 백엔드를 설계하세요. 매칭, 권위 서버, 반칙 방지, 리플레이 시스템을 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
    _c("레시피 추천 플랫폼을 설계하세요. 식이 제한, 재료 대체, 스케일링, 영양 분석을 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
    _c("임상 시험 관리 시스템을 설계하세요. 환자 등록, 동의 추적, 부작용 보고를 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
    _c("정밀 농업 플랫폼을 설계하세요. 센서 네트워크, 위성 영상, 수확량 예측, 관개 제어를 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
    _c("글로벌 공급망 가시성 플랫폼을 설계하세요. 실시간 추적, 수요 예측, 리스크 스코어링을 포함해야 합니다.", "COMPLEX", "system-design", "ko"),

    # ── Arabic COMPLEX ──
    _c("صمم نظام خلفي لألعاب متعددة اللاعبين يشمل المطابقة والخادم الموثوق ومكافحة الغش ونظام إعادة التشغيل.", "COMPLEX", "system-design", "ar"),
    _c("صمم منصة توصية وصفات تشمل قيود النظام الغذائي واستبدال المكونات والتحجيم وتحليل التغذية.", "COMPLEX", "system-design", "ar"),
    _c("صمم نظام إدارة التجارب السريرية يشمل تسجيل المرضى وتتبع الموافقة والإبلاغ عن الأحداث الضارة.", "COMPLEX", "system-design", "ar"),
    _c("صمم منصة زراعة دقيقة تشمل شبكات الاستشعار والصور الفضائية والتنبؤ بالمحصول والتحكم في الري.", "COMPLEX", "system-design", "ar"),

    # ── Portuguese COMPLEX ──
    _c("Projete um backend de jogo multiplayer com matchmaking, servidor autoritativo, anti-cheat e sistema de replay.", "COMPLEX", "system-design", "pt"),
    _c("Projete uma plataforma de recomendação de receitas com restrições dietéticas, substituição de ingredientes e análise nutricional.", "COMPLEX", "system-design", "pt"),
    _c("Projete um sistema de gerenciamento de ensaios clínicos com recrutamento, consentimento e relatórios de eventos adversos.", "COMPLEX", "system-design", "pt"),
    _c("Projete uma plataforma de agricultura de precisão com sensores, imagens de satélite e previsão de produtividade.", "COMPLEX", "system-design", "pt"),

    # ── Russian COMPLEX ──
    _c("Спроектируй бэкенд многопользовательской игры с матчмейкингом, авторитетным сервером, античитом и системой реплеев.", "COMPLEX", "system-design", "ru"),
    _c("Спроектируй платформу рекомендаций рецептов с диетическими ограничениями, заменой ингредиентов и анализом питания.", "COMPLEX", "system-design", "ru"),
    _c("Спроектируй систему управления клиническими испытаниями с набором пациентов, согласием и отчётами о побочных эффектах.", "COMPLEX", "system-design", "ru"),
    _c("Спроектируй платформу точного земледелия с сенсорами, спутниковой съёмкой и прогнозом урожайности.", "COMPLEX", "system-design", "ru"),

    # ── Spanish COMPLEX ──
    _c("Diseña un backend de juego multijugador con emparejamiento, servidor autoritativo, anti-trampas y sistema de repetición.", "COMPLEX", "system-design", "es"),
    _c("Diseña una plataforma de recomendación de recetas con restricciones dietéticas, sustitución de ingredientes y análisis nutricional.", "COMPLEX", "system-design", "es"),
    _c("Diseña un sistema de gestión de ensayos clínicos con reclutamiento, consentimiento y reporte de eventos adversos.", "COMPLEX", "system-design", "es"),
    _c("Diseña una plataforma de agricultura de precisión con sensores, imágenes satelitales y predicción de rendimiento.", "COMPLEX", "system-design", "es"),

    # ── German COMPLEX ──
    _c("Entwerfe ein Multiplayer-Spiel-Backend mit Matchmaking, autoritativem Server, Anti-Cheat und Replay-System.", "COMPLEX", "system-design", "de"),
    _c("Entwerfe eine Rezeptempfehlungsplattform mit Diätbeschränkungen, Zutatenersatz und Nährwertanalyse.", "COMPLEX", "system-design", "de"),
    _c("Entwerfe ein klinisches Studienmanagementsystem mit Patientenanwerbung, Einwilligung und Nebenwirkungsberichterstattung.", "COMPLEX", "system-design", "de"),
    _c("Entwerfe eine Präzisionslandwirtschaftsplattform mit Sensornetzwerken, Satellitenbildern und Ertragsprognose.", "COMPLEX", "system-design", "de"),

    # ── French COMPLEX ──
    _c("Conçois un backend de jeu multijoueur avec matchmaking, serveur autoritaire, anti-triche et système de replay.", "COMPLEX", "system-design", "fr"),
    _c("Conçois une plateforme de recommandation de recettes avec contraintes diététiques, substitution d'ingrédients et analyse nutritionnelle.", "COMPLEX", "system-design", "fr"),
    _c("Conçois un système de gestion d'essais cliniques avec recrutement, consentement et signalement des événements indésirables.", "COMPLEX", "system-design", "fr"),
    _c("Conçois une plateforme d'agriculture de précision avec capteurs, imagerie satellite et prédiction de rendement.", "COMPLEX", "system-design", "fr"),

    # ── Hindi COMPLEX ──
    _c("मल्टीप्लेयर गेम बैकएंड डिज़ाइन करें जिसमें मैचमेकिंग, अथॉरिटेटिव सर्वर, एंटी-चीट और रिप्ले सिस्टम शामिल हो।", "COMPLEX", "system-design", "hi"),

    # ── Turkish COMPLEX ──
    _c("Eşleştirme, yetkili sunucu, anti-cheat ve tekrar sistemi içeren çok oyunculu oyun arka ucu tasarlayın.", "COMPLEX", "system-design", "tr"),

    # ── Vietnamese COMPLEX ──
    _c("Thiết kế backend trò chơi nhiều người chơi với ghép cặp, máy chủ có thẩm quyền, chống gian lận và hệ thống phát lại.", "COMPLEX", "system-design", "vi"),

    # ── Polish COMPLEX ──
    _c("Zaprojektuj backend gry wieloosobowej z matchmakingiem, serwerem autorytatywnym, anti-cheatem i systemem powtórek.", "COMPLEX", "system-design", "pl"),

    # ── More COMPLEX: architecture, infrastructure, ml-pipeline, performance ──
    _c("Design a legal document workflow with version control, e-signature, audit trails, and compliance reporting.", "COMPLEX", "architecture", "en"),
    _c("Build a farm IoT platform with soil sensors, weather integration, irrigation automation, and yield prediction.", "COMPLEX", "infrastructure", "en"),
    _c("Design an automated music transcription pipeline with source separation, pitch detection, and notation export.", "COMPLEX", "ml-pipeline", "en"),
    _c("Optimize a supply chain simulation: reduce runtime from 2 hours to 15 minutes while preserving accuracy.", "COMPLEX", "performance", "en"),
    _c("Design a fashion e-commerce platform with virtual try-on, size recommendation, and inventory optimization.", "COMPLEX", "system-design", "en"),
    _c("Build a clinical decision support system with symptom input, differential diagnosis, and evidence retrieval.", "COMPLEX", "ml-pipeline", "en"),
    _c("Design a sports betting risk management system with odds calculation, exposure limits, and fraud detection.", "COMPLEX", "system-design", "en"),
    _c("Plan a migration from monolithic farm management software to microservices with zero downtime.", "COMPLEX", "migration", "en"),
    _c("Design a building energy management system with sensor fusion, occupancy prediction, and HVAC optimization.", "COMPLEX", "architecture", "en"),
    _c("Perform a security audit of a healthcare data platform. Address HIPAA, encryption, and access control.", "COMPLEX", "security-analysis", "en"),
    _c("Design a linguistics corpus annotation platform with inter-annotator agreement, quality control, and export.", "COMPLEX", "system-design", "en"),
    _c("Build a recipe recommendation engine with dietary constraints, ingredient availability, and nutrition optimization.", "COMPLEX", "ml-pipeline", "en"),
    _c("Design a multi-warehouse inventory optimization system with demand forecasting and transportation routing.", "COMPLEX", "system-design", "en"),
    _c("Implement a game server with authoritative physics, client prediction, lag compensation, and replay.", "COMPLEX", "complex-code", "en"),
    _c("Design an astronomy observatory scheduling system with telescope allocation, weather integration, and priority queuing.", "COMPLEX", "infrastructure", "en"),
    ...
    _c("医療データプラットフォームのセキュリティ監査を実施してください。HIPAA、暗号化、アクセス制御を検討してください。", "COMPLEX", "security-analysis", "ja"),
    _c("다중 창고 재고 최적화 시스템을 설계하세요. 수요 예측과 운송 경로 최적화를 포함해야 합니다.", "COMPLEX", "system-design", "ko"),
]
...
REASONING_B8: list[dict] = [
    # ── Formal proofs ──
    _c("Prove that the sum of the first n positive integers equals n(n+1)/2 using mathematical induction.", "REASONING", "formal-proof", "en"),
    ...
    # ── Math derivations ──
    _c("Derive the formula for the sum of a geometric series. Prove convergence when |r| < 1.", "REASONING", "math-derivation", "en"),
    _c("Derive the quadratic formula by completing the square. Show all steps.", "REASONING", "math-derivation", "en"),
    _c("Derive the formula for the nth Fibonacci number using generating functions.", "REASONING", "math-derivation", "en"),
    _c("Derive the expected value of a geometric random variable. Prove it equals 1/p.", "REASONING", "math-derivation", "en"),
    _c("Derive the Stirling approximation for n! and prove the error bound.", "REASONING", "math-derivation", "en"),

    # ── Algorithm proofs ──
    _c("Prove that Dijkstra's algorithm finds shortest paths in graphs with non-negative weights. Use induction on distance.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that binary search runs in O(log n) time. State and prove the recurrence.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that merge sort is correct using induction on the merge operation.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that the greedy algorithm for activity selection is optimal. Use the exchange argument.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that Huffman coding produces an optimal prefix code. Use the lemma about merging.", "REASONING", "algorithm-proof", "en"),

    # ── Game theory ──
    _c("In the ultimatum game, derive the subgame-perfect equilibrium. Prove why the responder accepts any positive offer.", "REASONING", "game-theory", "en"),
    _c("Prove that in a finite two-player zero-sum game, a Nash equilibrium always exists. Use the minimax theorem.", "REASONING", "game-theory", "en"),
    _c("In a second-price auction with n bidders, prove that truthful bidding is a dominant strategy.", "REASONING", "game-theory", "en"),
    _c("Derive the mixed strategy Nash equilibrium for matching pennies. Show the indifference condition.", "REASONING", "game-theory", "en"),

    # ── Logic puzzles ──
    _c("Three boxes: one has two gold coins, one has two silver, one has one of each. You pick a gold coin. Prove the probability the other is gold is 2/3.", "REASONING", "logic-puzzle", "en"),
    _c("Prove that in the Monty Hall problem, switching gives 2/3 probability of winning. Use Bayes' theorem.", "REASONING", "logic-puzzle", "en"),
    _c("N people have hats. Each sees others' hats. Prove that with perfect play, exactly N-1 guesses can be correct.", "REASONING", "logic-puzzle", "en"),
    _c("Prove that the poisoned wine puzzle with 1000 bottles and 10 prisoners has a solution using binary encoding.", "REASONING", "logic-puzzle", "en"),

    # ── Formal logic ──
    _c("Prove that (P → Q) ∧ (Q → R) ⊢ (P → R) using natural deduction.", "REASONING", "formal-logic", "en"),
    _c("Prove that ¬(P ∧ Q) is logically equivalent to (¬P ∨ ¬Q) using truth tables and then semantic argument.", "REASONING", "formal-logic", "en"),
    _c("Prove that the resolution rule is sound: if C1 and C2 are satisfiable and resolve to C3, then C1 ∧ C2 → C3.", "REASONING", "formal-logic", "en"),
    ...
    # ── Japanese REASONING ──
    _c("数学的帰納法を用いて、最初のn個の正の整数の和がn(n+1)/2であることを証明してください。", "REASONING", "formal-proof", "ja"),
    _c("背理法を用いて√2が無理数であることを証明してください。", "REASONING", "formal-proof", "ja"),
    _c("等比級数の和の公式を導出してください。|r|<1のとき収束することを証明してください。", "REASONING", "math-derivation", "ja"),
    _c("ダイクストラ法が非負重みグラフで最短経路を見つけることを証明してください。", "REASONING", "algorithm-proof", "ja"),
    _c("モンティ・ホール問題で、ドアを変えると勝つ確率が2/3であることを証明してください。", "REASONING", "logic-puzzle", "ja"),

    # ── Korean REASONING ──
    _c("수학적 귀납법을 사용하여 처음 n개의 양의 정수의 합이 n(n+1)/2임을 증명하세요.", "REASONING", "formal-proof", "ko"),
    _c("귀류법을 사용하여 √2가 무리수임을 증명하세요.", "REASONING", "formal-proof", "ko"),
    _c("등비급수의 합 공식을 유도하세요. |r|<1일 때 수렴함을 증명하세요.", "REASONING", "math-derivation", "ko"),
    _c("다익스트라 알고리즘이 비음수 가중치 그래프에서 최단 경로를 찾음을 증명하세요.", "REASONING", "algorithm-proof", "ko"),
    _c("몬티 홀 문제에서 문을 바꾸면 이길 확률이 2/3임을 증명하세요.", "REASONING", "logic-puzzle", "ko"),

    # ── Arabic REASONING ──
    _c("أثبت أن مجموع أول n أعداد صحيحة موجبة يساوي n(n+1)/2 باستخدام الاستقراء الرياضي.", "REASONING", "formal-proof", "ar"),
    ...
    _c("Prove que a soma dos primeiros n inteiros positivos é n(n+1)/2 usando indução matemática.", "REASONING", "formal-proof", "pt"),
    _c("Prove que sqrt(2) é irracional usando prova por contradição.", "REASONING", "formal-proof", "pt"),
    _c("Derive a fórmula da soma da série geométrica. Prove convergência quando |r| < 1.", "REASONING", "math-derivation", "pt"),

    # ── Russian REASONING ──
    _c("Докажи, что сумма первых n положительных целых равна n(n+1)/2, используя математическую индукцию.", "REASONING", "formal-proof", "ru"),
    _c("Докажи, что sqrt(2) иррационален, используя доказательство от противного.", "REASONING", "formal-proof", "ru"),
    _c("Выведи формулу суммы геометрической прогрессии. Докажи сходимость при |r| < 1.", "REASONING", "math-derivation", "ru"),

    # ── Spanish REASONING ──
    _c("Demuestra que la suma de los primeros n enteros positivos es n(n+1)/2 usando inducción matemática.", "REASONING", "formal-proof", "es"),
    _c("Demuestra que sqrt(2) es irracional usando prueba por contradicción.", "REASONING", "formal-proof", "es"),
    _c("Deriva la fórmula de la suma de la serie geométrica. Demuestra convergencia cuando |r| < 1.", "REASONING", "math-derivation", "es"),

    # ── German REASONING ──
    _c("Beweise, dass die Summe der ersten n positiven ganzen Zahlen n(n+1)/2 ist, mit vollständiger Induktion.", "REASONING", "formal-proof", "de"),
    _c("Beweise, dass sqrt(2) irrational ist, mit Widerspruchsbeweis.", "REASONING", "formal-proof", "de"),

    # ── French REASONING ──
    _c("Démontre que la somme des n premiers entiers positifs vaut n(n+1)/2 par récurrence.", "REASONING", "formal-proof", "fr"),
    ...
    # ── Turkish REASONING ──
    _c("Matematiksel tümevarım kullanarak ilk n pozitif tam sayının toplamının n(n+1)/2 olduğunu kanıtlayın.", "REASONING", "formal-proof", "tr"),

    # ── Vietnamese REASONING ──
    _c("Chứng minh rằng tổng n số nguyên dương đầu tiên bằng n(n+1)/2 bằng quy nạp toán học.", "REASONING", "formal-proof", "vi"),

    # ── Polish REASONING ──
    _c("Udowodnij, że suma pierwszych n liczb całkowitych dodatnich wynosi n(n+1)/2, używając indukcji matematycznej.", "REASONING", "formal-proof", "pl"),

    # ── More REASONING: formal-proof, math-derivation, algorithm-proof, logic-puzzle ──
    _c("Prove that the product of two consecutive integers is always even. Use direct proof.", "REASONING", "formal-proof", "en"),
    _c("Prove that a graph is bipartite if and only if it contains no odd cycles.", "REASONING", "formal-proof", "en"),
    _c("Derive the formula for the sum of an arithmetic series. Prove it using induction.", "REASONING", "math-derivation", "en"),
    _c("Derive the binomial theorem (a+b)^n = sum C(n,k) a^k b^(n-k). Prove by induction.", "REASONING", "math-derivation", "en"),
    _c("Prove that heap sort runs in O(n log n) in-place. Analyze the heapify and extract operations.", "REASONING", "algorithm-proof", "en"),
    _c("Prove that the greedy coin-changing algorithm is optimal for standard US denominations.", "REASONING", "algorithm-proof", "en"),
    _c("In the 100 prisoners and light bulb puzzle, prove the optimal strategy succeeds with probability > 30%.", "REASONING", "logic-puzzle", "en"),
    _c("Prove that in a knockout tournament with n teams, exactly n-1 games are played.", "REASONING", "formal-proof", "en"),
    _c("Derive the closed form for the recurrence T(n) = 2T(n/2) + n. Prove it's O(n log n).", "REASONING", "math-derivation", "en"),
